...
const ViewRole =() =>{
  ...
  useEffect( ()=>{
      ...
      axios.get(`${apiConfig.baseURL}/api/roles/allRoles`)
      .then((res) => {
        setData(res.data);
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete(`${apiConfig.baseURL}/api/roles/deleteRole/${id}`)
          .then((res) => {
            Swal.fire({
              icon: 'success',
              title: 'Deleted!',
            ...
            <div className="main-panel">
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <Link to="/addroles" className="btn btn-success">Add +</Link>
                </div>
                      ...
                      <tbody>
                      {
                        data.map((d,i) =>(
                            ...
                            <tr key={i}>
                                ...
                                <td>
                                <Link to={`/editroles/${d._id}`} className="btn btn-primary">Edit</Link>
