...
useEffect( ()=>{
    ...
    axios.get(`${apiConfig.baseURL}/api/foodmenu/editfoodmenu/${id}`)
    .then(res => { console.log(res)
       ...
       const foodIngredientIds = res.data.foodingredientId.map(id => ({ value: id, label: id }));
...
formData.append('bar', bar);
    ...
    axios.put(`${apiConfig.baseURL}/api/foodmenu/updatefoodmenu/${id}`,formData, config)
